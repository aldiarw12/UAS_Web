...
<head>
  ...
  <meta name="description" content="Bank ABC">
  ...
  <!-- Favicon icon -->
  <link rel="shortcut icon" href="assets/img/Zj.jpg" type="image/x-icon">
  ...
  <main class="flex-shrink-0">
    <div class="container pt-5">
      ...
      <div class="alert alert-light d-flex align-items-center mb-5" role="alert">
        ...
        <div>
          Selamat Datang di <strong>Bank ABC</strong>. Silahkan pilih halaman yang ingin ditampilkan.
        </div>
      </div>
  ...
  <footer class="footer mt-auto py-4">
    <div class="container-fluid">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2021 - <a href="Bank ABC" target="_blank" class="text-danger text-decoration-none">Bank ABC</a>. All rights reserved.
      </div>
    </div>
  </footer>
